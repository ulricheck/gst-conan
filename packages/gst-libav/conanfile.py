...
class GstLibav(ConanFile):
    ...
    def __init__(self, output, runner, user, channel):
        ...
        if gst_conan.DEBUG_MODE:
            self.output.info("--------------------------")
            self.output.info("GstLibav.__init__")
    ...
    def build(self):
        if gst_conan.DEBUG_MODE:
            self.output.info("--------------------------")
            self.output.info("GstLibav.build")
    ...
    def package(self):
        if gst_conan.DEBUG_MODE:
            self.output.info("--------------------------")
            self.output.info("GstLibav.package")
            self.output.info(json.dumps(self.__dict__, indent=4, sort_keys=True, skipkeys=True, default=lambda x: None) + "")
            self.output.info("--------------------------")
    ...
    def package_info(self):
        ...
        if gst_conan.DEBUG_MODE:
            self.output.info("--------------------------")
            self.output.info("GstLibav.package_info")
            self.output.info(json.dumps(self.__dict__, indent=4, sort_keys=True, skipkeys=True, default=lambda x: None) + "")
            self.output.info("--------------------------")
    ...
    def source(self):
        if gst_conan.DEBUG_MODE:
            self.output.info("--------------------------")
            self.output.info("GstLibav.source")
            self.output.info(json.dumps(self.__dict__, indent=4, sort_keys=True, skipkeys=True, default=lambda x: None) + "")
            self.output.info("--------------------------")
